...
# python sample_tools/LR4FT.py -d CIFAR10 --val --gpu --no_aug -p 0.1  &> DC_sample/logs_LR4FT/CIFAR10_0.1.log
...
def load_features(dataset, dataset_type='train'):
    ...
    if dataset == "CIFAR10":
        feature_path = "features_lpft/CIFAR10_" + dataset_type + ".npy"
    elif dataset == "CIFAR100":
        feature_path = "features_lpft/CIFAR100_" + dataset_type + ".npy"
    elif dataset == "ImageNet":
        feature_path = "features_lpft/ImageNet_" + dataset_type + ".npy"
    else:
