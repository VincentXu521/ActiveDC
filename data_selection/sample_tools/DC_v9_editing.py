...
# python sample_tools/DC_v8_no_save.py -b CIFAR10 -d CIFAR10 --val --gpu --no_aug -p 2
# python sample_tools/DC_v9_editing.py -b CIFAR10 -d CIFAR10 --val --gpu --alpha 0.7 --xi 0 -p 1
